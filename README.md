...
* Highlighted Items - List of items the plugin should keep track of no matter the GE or HA value. You can specify a minimum of the item by including ">X" behind the item.
